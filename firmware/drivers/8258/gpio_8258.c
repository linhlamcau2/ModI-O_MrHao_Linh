...
// RD_EDIT: PWM_FUNC_R
#ifdef PWM_FUNC_R
STATIC_ASSERT((PWM_FUNC_R == AS_PWM)||((PWM_FUNC_R == AS_PWM_SECOND)&&((PWM_R==GPIO_PC4)||(PWM_R==GPIO_PC4)||(PWM_R==GPIO_PD5))));
#endif
#ifdef PWM_FUNC_G
STATIC_ASSERT((PWM_FUNC_G == AS_PWM)||((PWM_FUNC_G == AS_PWM_SECOND)&&((PWM_G==GPIO_PC4)||(PWM_G==GPIO_PC4)||(PWM_G==GPIO_PD5))));
#endif
#ifdef PWM_FUNC_B
STATIC_ASSERT((PWM_FUNC_B == AS_PWM)||((PWM_FUNC_B == AS_PWM_SECOND)&&((PWM_B==GPIO_PC4)||(PWM_B==GPIO_PC4)||(PWM_B==GPIO_PD5))));
#endif
#ifdef PWM_FUNC_W
STATIC_ASSERT((PWM_FUNC_W == AS_PWM)||((PWM_FUNC_W == AS_PWM_SECOND)&&((PWM_W==GPIO_PC4)||(PWM_W==GPIO_PC4)||(PWM_W==GPIO_PD5))));
#endif

...
#define TRANSITION_TIME_DEFAULT_VAL	0
	#else
#define TRANSITION_TIME_DEFAULT_VAL (GET_TRANSITION_TIME_WITH_STEP(1, TRANSITION_STEP_RES_1S)) // RD_EDIT: Transittion // (0x41)  // 0x41: 1 second // 0x00: means no default transition time
	#endif
#endif
#endif
...
//---------------  LED / PWM
#if(PCBA_8258_SEL == PCBA_8258_DONGLE_48PIN)
#if((TYPE_HARDWARE_SWITCH == X2_TOUCH_SWITCH) || (TYPE_HARDWARE_SWITCH == X3_TOUCH_SWITCH) || \
		(TYPE_HARDWARE_SWITCH == X4_TOUCH_SWITCH) || TYPE_HARDWARE_SWITCH == X2_MACHINE_SWTCH || TYPE_HARDWARE_SWITCH == X3_MACHINE_SWTCH)

	#define PWM_R       GPIO_PD2		//red //RD_EDIT Re Config PWM
	#define PWM_G       GPIO_PD2 //GPIO_PWM0A2		//green
	#define PWM_B       GPIO_PD2 //GPIO_PWM3B0		//blue
	#define PWM_W       GPIO_PD2 //GPIO_PWM4B1		//white
...
#define PWM_R       GPIO_PD5		//red //RD_EDIT Re Config PWM
#define PWM_G       GPIO_PD5 //GPIO_PWM0A2		//green
#define PWM_B       GPIO_PD5 //GPIO_PWM3B0		//blue
#define PWM_W       GPIO_PD5 //GPIO_PWM4B1		//white
#endif

#if(TYPE_HARDWARE_SWITCH == X1_SOCKET)
#define PWM_R       GPIO_PWM3D2		//red //RD_EDIT Re Config PWM
#define PWM_G       GPIO_PWM3D2 //GPIO_PWM0A2		//green
#define PWM_B       GPIO_PWM3D2 //GPIO_PWM3B0		//blue
#define PWM_W       GPIO_PWM3D2 //GPIO_PWM4B1		//white
#endif

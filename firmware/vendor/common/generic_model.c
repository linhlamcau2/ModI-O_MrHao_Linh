...
int mesh_g_onoff_st_rsp(mesh_cb_fun_par_t *cb_par)
{
    ...
    return mesh_tx_cmd_g_onoff_st(cb_par->model_idx, p_model->com.ele_adr, cb_par->adr_src, 0, 0, cb_par->op_rsp); //RD_EDIT: mesh_tx_cmd_g_onoff_st
}
...
int mesh_cmd_sig_g_onoff_get(u8 *par, int par_len, mesh_cb_fun_par_t *cb_par)
{
	...
	//return FPT_Mess_G_ON_OFF_Stt(cb_par->adr_src, cb_par->adr_dst, 0x02);
}
...
const mesh_cmd_sig_func_t mesh_cmd_sig_func[] = {
  ...
  //  CMD_NO_STR(MODE_APP_BIND, 0, SIG_MD_CFG_CLIENT, SIG_MD_CFG_SERVER, RD_mesh_cmd_sig_cfg_bind, MODE_APP_STATUS),

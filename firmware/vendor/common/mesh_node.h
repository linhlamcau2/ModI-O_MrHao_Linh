...
#include "../mesh/RD_HARDWARE_TYPE/RD_Hardware_Type.h"
#if NL_API_ENABLE
...
//--------------------------------------- node composition data
	...
	#else //RD_EDIT A Set for TYPE hardware 2
//#define LIGHT_CNT                       (4)     // means instance count // RD_EDIT: element of Light
		#if(TYPE_HARDWARE_SWITCH == X5_CEILING_SWITCH)
		#define LIGHT_CNT                       (5)     // means instance count
		#endif
		...
		#endif
		#if((TYPE_HARDWARE_SWITCH == X1_TOUCH_SWITCH) || (TYPE_HARDWARE_SWITCH == X1_MACHINE_SWTCH) || (TYPE_HARDWARE_SWITCH == X1_SOCKET)|| (TYPE_HARDWARE_SWITCH == HIPOW_TOUCH_SWITCH) )
...
#define SCENE_CNT_MAX			(20) // RD_EDIT: SCENE_CNT_MAX
...
#endif
}model_scene_t;			// RD_EDIT: Scene model_t

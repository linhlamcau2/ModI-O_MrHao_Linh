...
#define FAST_PROVISION_ENABLE		 FAST_PROVISION_EN_RD //RD_Edit: FAST_PROVISION_ENABLE
#endif
...
#define LIGHT_TYPE_SEL				LIGHT_TYPE_PANEL
		#endif
	#else
#define LIGHT_TYPE_SEL				LIGHT_TYPE_PANEL //LIGHT_TYPE_NONE	//  RD_EDIT Light_Type
	#endif
#endif
#endif
...
#else
#define MD_LIGHTNESS_EN             0	// RD_EDIT dissnable lightness
...
#define MD_MESH_OTA_EN				0   // must 0 //RD_EDIT:
...
#define MD_ONOFF_EN                 1   // must 1 // RD_EDIT d MD_ONOFF_EN
...
#define MD_CLIENT_EN                1   // just SIG MD
	#else
#define MD_SERVER_EN                1   // SIG and vendor MD
#define MD_CLIENT_EN                0   // just SIG MD //RD_EDIT: MD_CLIENT_EN
	#endif
    #if(DUAL_VENDOR_EN)
#define MD_CLIENT_VENDOR_EN         0
...
#define MAX_LPN_NUM					5   // should be less than or equal to 16 RD_EDIT Friend MAX

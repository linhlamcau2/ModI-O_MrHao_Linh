...
//#define FW_VERSION_TELINK_RELEASE_3 (RD_VID_TYPE |((0x34)<<16))  // user can't modify    // big endian
...
#define MESH_VID		    DU_FW_VER       // in the du mode ,we will use to set version .
	#else
#define MESH_VID		    FW_VERSION_TELINK_RELEASE //(RD_VID_TYPE) //FW_VERSION_TELINK_RELEASE       // user can redefine
	#endif

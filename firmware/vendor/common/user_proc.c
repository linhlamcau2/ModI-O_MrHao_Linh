...
#include "../mesh/RD_Switch/RD_Switch.h"
#if(AIS_ENABLE)
	#if DU_ENABLE
#include "user_du.h"
...
// test md5 function part
	...
	*/
	uuid_mesh_t NameSpace_DNS = { /* 6ba7b810-9dad-11d1-80b4-00c04fd430c8 */
		...
		key_VT_RD[0]    = 0x00;
		key_VT_RD[1]    = Device_BROADCRARD_0;
		key_VT_RD[2]    = Device_BROADCRARD_1;
		key_VT_RD[3]    = Device_BROADCRARD_2;
		key_VT_RD[4]    = VERSION_FIRM_H;
		key_VT_RD[5]    = VERSION_FIRM_L;
		key_VT_RD[6]    = 0x28;
		key_VT_RD[7]    = 0x04;
